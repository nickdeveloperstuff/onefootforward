defmodule SuperdupernovaWeb.BreadcrumbsTestLive do
  ...
  import SuperdupernovaWeb.Widgets.Layout, only: [breadcrumbs_from_path: 1]
  ...
  def render(assigns) do
    ...
    <div class="p-8 space-y-8">
      <h1 class="text-3xl font-bold mb-8">Breadcrumbs Widget Test Page</h1>
      
      <!-- Basic Breadcrumbs -->
      <section>
        <h2 class="text-2xl font-semibold mb-4">Basic Breadcrumbs</h2>
      ...
      <section>
        <h2 class="text-2xl font-semibold mb-4">Breadcrumbs with LiveView Navigation</h2>
        <Layout.breadcrumbs items={[
          %{label: "Home", navigate: "/"},
      ...
      <section>
        <h2 class="text-2xl font-semibold mb-4">Breadcrumbs with Icons</h2>
      ...
      <section>
        <h2 class="text-2xl font-semibold mb-4">Dynamic Breadcrumbs from Path</h2>
      ...
      <section>
        <h2 class="text-2xl font-semibold mb-4">Mixed Navigation Types</h2>
        <Layout.breadcrumbs items={[
          %{label: "Home", href: "/"},
          %{label: "Dashboard", navigate: "/dashboard"},
