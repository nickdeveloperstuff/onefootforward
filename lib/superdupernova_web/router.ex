defmodule SuperdupernovaWeb.Router do
  use SuperdupernovaWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {SuperdupernovaWeb.Layouts, :root}
  ...
  scope "/", SuperdupernovaWeb do
    ...
    sign_in_route register_path: "/register",
                  ...
                  on_mount: [{SuperdupernovaWeb.LiveUserAuth, :live_no_user}],
                  overrides: [
                    SuperdupernovaWeb.AuthOverrides,
    ...
    confirm_route Superdupernova.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [SuperdupernovaWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Superdupernova.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [SuperdupernovaWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
  ...
  # scope "/api", SuperdupernovaWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:superdupernova, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SuperdupernovaWeb.Telemetry
